...
function App() {
  ...
  const handleSubmit=async(event)=>{
    ...
    setSub(true)
    try{
      const res=await axios.post("https://pinplace.onrender.com/api/pins/createpin",newPin);
  ...
  const deletePin=async(id)=>{
    try{
    axios.delete(`https://pinplace.onrender.com/api/pins/delete/${id}`);
  ...
  useEffect(() => {
    axios
      .get("https://pinplace.onrender.com/api/pins/getallpins")
